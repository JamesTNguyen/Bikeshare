...
# Question 2
Question 2 examines the popular stations and trips. Analysis is provided below to which was used to answer these questions.

1. What is the common start station?
2. What is the most common end station?
3. What is the most common trip from start to end?

```{r chunk 4, include=TRUE}
by(ALL$Start.Station, ALL$location, summary)
...
3. What are the earliest, most recent, most common year of birth (Only available for NYC and Chicago)

```{r chunk 7, include=TRUE}
#y(ALL$User.Type, ALL$location, count)
